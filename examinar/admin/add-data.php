...
{       
    ...
    for($i=1; $i<=$total; $i++)
    {
        $cc = strtoupper($_POST["course_code$i"]);
        $ct = strtoupper($_POST["course_title$i"]);        
        $sql="INSERT INTO exam_type(course_code,course_title) VALUES('".$cc."','".$ct."')";
        $sql = $con->query($sql);        
    }
                                ...
                                <form method="post">
                                    ...
                                    <table class='table table-bordered'>
                                        ...
                                        for($i=1; $i<=$_POST["no_of_rec"]; $i++) { ?>
                                            <tr>
                                                <td><?php echo $i; ?></td>
                                                <td><input type="text" name="course_code<?php echo $i; ?>" placeholder="Course code" class='form-control' required/></td>
                                                <td><input type="text" name="course_title<?php echo $i; ?>" placeholder="Course title" class='form-control' required/></td>
                                            </tr>
                                        <?php } ?>
                                        <tr>
                                            <td colspan="3">
                                                <button type="submit" name="save_mul" class="btn btn-primary"><i class="glyphicon glyphicon-ok"></i> &nbsp; Add Course(s)</button> 
                                                <a href="exam_menu2.php" class="btn btn-large btn-success"> <i class="glyphicon glyphicon-remove"></i> &nbsp; Cancel</a>
                                            </td>
                                        </tr>
                                    </table>
                                </form>
